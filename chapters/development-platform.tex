The new hardware originally intended for Støvneng's thesis was still unavailable at the beginning of this thesis.
...
However, this should not be a significant problem as the hardware design can simply be scaled down by reducing the size of the sblock matrix or the performance.

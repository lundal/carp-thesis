...
\TODO
Simplest.
Takes rule and stores it in Rule BRAM at given index.

\subsection{LUT Writer}

\TODO
Simplest.
Takes LUT and stores it in LUT BRAM at given index.

\subsection{Information Sender}

\TODO
Used as part of the adaptive interface.
Sends information about matrix size, bits per state/type, number of rules, amount of counters, fitness type, ++.

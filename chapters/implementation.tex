...
There are currently two implemented fitness modules.
The Live Count Fitness and the DFT Fitness.

\subsection{Live Count}

\TODO
Very simple example.
Simply copies from Live Count Buffer to Fitness Buffer (when buffers have data and room).
Allows software-side fitness evaluation.

\subsection{Discrete Fourier Transform}

\TODO
DFT finds frequencies, can detect patterns in complex output.
Revised version of Ola Martin's.

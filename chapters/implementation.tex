...
\begin{figure}[!ht]
    ...
    \caption{Detailed block diagram of the communication module.}
...
\begin{figure}[!ht]
    ...
    \caption[Wave diagram for the FIFO buffer.]{
...
\begin{figure}[!ht]
    ...
    \caption{Detailed block diagram of the Fetch module.}
...
\begin{figure}[!ht]
    ...
    \caption[Detailed block diagram of the Cell Writer Reader.]{
...
\begin{figure}[!ht]
    ...
    \caption[Detailed block diagram of the Development module.]{
...
\begin{figure}[!ht]
    ...
    \caption{Detailed block diagram of the Cellular Automata.}

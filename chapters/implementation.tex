\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.78\textwidth]{implementation-simple}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.72\textwidth]{implementation-communication}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.84\textwidth]{statemachine-receive}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.69\textwidth]{implementation-fetch}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.72\textwidth]{implementation-control}
...
\begin{figure}[!ht]
    ...
    \includegraphics[width=1.04\textwidth]{implementation-cell-writer-reader}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.56\textwidth]{statemachine-cell-writer-reader}
...
The Development Module is responsible for providing the ontogenetic aspect of the system by allowing cells to be changed based on user-supplied development rules described in Appendix~\todo{ref}.
...
\begin{figure}[!ht]
    ...
    \includegraphics[width=1.10\textwidth]{implementation-development}
...
\todo{explain devstep or find another term – development phase?}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.68\textwidth]{implementation-cellular-automata}
...
The new state is determined by the using the neighbor states as the input to the LUT, according to the format detailed in Appendix~\todo{ref}.
...
\todo{explain runstep or use other term – cell update step?}
...
The pipeline is interlocked, since both stages can run for hundreds of cycles, and is controlled by the state machine in \todo{fig}.

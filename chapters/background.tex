The field of bio-inspired hardware systems encompass a wide variety of technologies that take advantage of different natural concepts.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.5\textwidth]{poe}
    \caption[POE model]{
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=29\block]{fpga}
    \caption[FPGA]{

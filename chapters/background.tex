...
Langton attempted to connect Wolframs classes to transfer function complexity \cite{langton1990edgeofchaos}.
...
\begin{figure}[!ht]
    ...
    \caption[FPGA]{
        ...
        An array of configurable logic blocks (CLBs) and I/O pins are connected by a network of interconnects.
    }
    \label{fig:fpga}
\end{figure}

...
\todo{rewrite}
Development is needed because a complete spesification of a complex organism would require too much information.
It is several orders of magnitude greater than that of one cell and it's development rules.
It can also be used to allow systems to repair themselves after sustaining damage.
For the same reasons, artificial development is lucrative...
Perhaps the most known and widely used artificial development systems are Lindenmayer Systems.

\subsection{Lindenmayer Systems}

Lindenmayer was a biologist and botanist that in 1968 introduced a system to describe the growth of plants \cite{lindenmayer1968models}.
The Lindenmayer System (L-System) as it is known is a form of parallel generative grammar.
Starting with an axiom, a string is built by iteratively applying all the grammar rules in parallel.
...
Can add cells and allow program to grow.
...
CAs are also used as an environment for creating machines that replicate \cn{von neumann}.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.45\textwidth]{neighborhood}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.70\textwidth]{complexity-classes}

The field of bio-inspired computing encompass a wide variety of technologies that take advantage of different natural concepts.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.48\textwidth]{poe}
    \caption[POE model]{
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=42\block]{ga}
...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{development/00}
        \caption{Iteration 0}
    \end{subfigure}
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{development/01}
        \caption{Iteration 1}
    \end{subfigure}
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{development/02}
        \caption{Iteration 2}
    \end{subfigure}
    \begin{subfigure}{0.24\textwidth}
        \centering
        \includegraphics[width=0.9\textwidth]{development/03}
        \caption{Iteration 3}
    \end{subfigure}
    \caption[Development]{
...
Development is needed because a complete specification of a complex organism requires much more information than practically can be stored; it is several orders of magnitude greater than that of one cell and its development rules.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=0.80\textwidth]{computing-principles}
...
Cell updates can be synchronous or asynchronous, and in the latter case the CA can be either deterministic or nondeterministic depending on the order in which cells update.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=20\block]{neighborhood}
...
\begin{figure}[!ht]
    ...
    \caption[Complexity classes]{
        The location of Wolfram's complexity classes in $\lambda$ space.
        (Adapted reprint from \cite{langton1990edgeofchaos})
    }
    \label{fig:complexity-classes}
\end{figure}

Langton attempted to connect Wolfram's classes to transfer function complexity \cite{langton1990edgeofchaos}.
...
The problem with using EAs to program CAs is that the search spaces are vast, even for the simplest binary CAs ($2^{Neighborhood \cdot Cells}$ configurations\footnotemark).
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=22\block]{evo-devo-ca}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=24\block]{fpga}
    \caption[FPGA]{
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=22\block]{sblock}
    \caption[Sblock]{
...
The Information Mechanics Group at MIT Laboratory for Computer Science has had a focus the question ``How can computation and computers best be adapted to the constraints and opportunities afforded by microscopic physics?''

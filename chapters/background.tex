...
The cells, known as sblocks, are very simple structures; they consist of a configurable lookup table (LUT) and a flip-flop (FF), as shown in \figurename~\ref{fig:sblock}.
...
\begin{itemize}
    ...
    \item Dendrites and Axons grown successively

...
Additionally, biological systems exhibit a wide range of characteristics that could possibly revolutionize computing, such as replication, learning, graceful degradation, robustness, redundancy, self-assembly and self-repair.

% Method

\todo{unfinished}

This has formed the field of bio-inspired computation.
The goal is to use biologically-inspired techniques in/to...

Artificial evolution and development.
Artificial neural networks, cellular automata.
...
In 2002, NTNU invested in dedicated FPGA hardware for the purpose of creating a platform for experimentation with Cellular Automata (CAs) in combination with artificial evolution and development.
...
The task of the specialization project leading up to this thesis was to finish the extended platform by implementing a new PCI Express communication module, and to verify the platforms functionality in hardware.
The verificaton process uncovered many issues, some of which made the platform unusable, and others which made debugging and fixing very difficult.
This led to the decision of rebuilding the entire platform from scratch, which is \todo{covered by -> better expression} this thesis.
